class Zen_DogHouseRecipe extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	override void Init()
	{
		...
		m_Name = "Craft Dog House Kit";	// action name in game
