/*class Zen_PaintCrossbowGreenRecipe extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	override void Init()
	{
		int cost = 25;
		string useItem = "Spraycan_Green";
		string onItem = "Crossbow_Black";
		string resultItem = "Crossbow_Green";
		
		
		m_Name = "Paint Crossbow Green";	// action name in game
