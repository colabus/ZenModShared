class Zen_PaintBlackMosinCamoRecipe extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	override void Init()
	{
		int cost = 25;
		string useItem = "Spraycan_Green";
		string onItem = "Mosin9130_Black";
