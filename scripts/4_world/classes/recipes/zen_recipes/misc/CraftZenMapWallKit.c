class CraftZenMapWallKit extends RecipeBase
{
	override void Init()
	{
		string useItem = "MetalWire";
		string onItem = "WoodenStick";
		string resultItem = "Zen_CraftableMapKit";

		m_Name = "Craft Wall Map Kit";	// action name in game
		...
		m_MinQuantityIngredient[1] = 2;	//quantity required for secondary ingredient
		...
		//result1
		AddResult(resultItem);//add results here
