class Zen_PaintMichBlackRecipe extends RecipeBase
{
	override void Init()
	{
		int cost = 25;
		string useItem = "Spraycan_Black";
		string onItem = "Mich2001Helmet";
		string resultItem = "Zen_Mich2001Helmet_Black";
		
		m_Name = "Paint Helmet Black";	// action name in game
