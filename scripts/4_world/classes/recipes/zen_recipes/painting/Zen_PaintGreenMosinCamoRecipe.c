class Zen_PaintGreenMosinCamoRecipe extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	override void Init()
	{
		int cost = 25;
		string useItem = "Spraycan_Black";
		string onItem = "Mosin9130_Green";
		string resultItem = "Mosin9130_Camo";
		
		
		m_Name = "Paint Mosin Camo";	// action name in game
